...
# Convert file
rosbag filter ${ROSBAG} '/home/liu/livox/out/topic_base_'${INSTANCE}'.bag' "topic == '/livox/lidar_${BASE}'"
rosbag filter ${ROSBAG} '/home/liu/livox/out/topic_target_'${INSTANCE}'.bag' "topic == '/livox/lidar_${TARGET}'"
rosrun pcl_ros bag_to_pcd /home/liu/livox/out/topic_base_${INSTANCE}.bag /livox/lidar_${BASE} /home/liu/livox/Livox_automatic_calibration_parallel/${INSTANCE}/data/Base_LiDAR_Frames
rosrun pcl_ros bag_to_pcd /home/liu/livox/out/topic_target_${INSTANCE}.bag /livox/lidar_${TARGET} /home/liu/livox/Livox_automatic_calibration_parallel/${INSTANCE}/data/Target-LiDAR-Frames
tmux kill-server
